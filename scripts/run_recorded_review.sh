...
echo "Brief:    $ROOT/docs/RECORDED_QA_BRIEF.md"
echo "Checklist:$ROOT/docs/MANUAL_QA_CHECKLIST.md"
echo "Template: $ROOT/qa/RECORDED_REVIEW_TEMPLATE.md"
...
echo "- Log findings with timestamps in qa/RECORDED_REVIEW_TEMPLATE.md"
