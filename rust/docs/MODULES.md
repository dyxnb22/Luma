...
| Proxy | `proxy` / `px` | Available — controller-first Mihomo status, groups/nodes, mode and local macOS HTTP/SOCKS proxy controls; unavailable when Mihomo is not running | on |
