...
pub use adapters::{
    ...
    SqliteNotesIndex, SqliteQuicklinksRepository, SqliteRecallRepository, SqliteRecordsRepository,
...
pub use ports::{
    ...
    FakeGitRepository, FakeKeychain, FakeMarkdownWatcher, FakeNetworkProbe, FakeNotesWorkspace,
    FakeOpenPath, FakePasteboard, FakeProjectWorkspace, FakeProxyCore, FakeRecipeEnvironment,
    FakeRuntimePort, FakeSpeech, FakeSshConfigPort, FakeSystemProxy, FakeWindowCatalog, FixedClock,
    GitBranch, GitCommit, GitDiff, GitError, GitFile, GitProjectRoot, GitRepositoryPort,
    GitRepositoryState, KeychainError, KeychainPort, MarkdownWatchPort, MemoryClipboardHistory,
