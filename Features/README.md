...
Treat `ModuleRegistry.swift`, `ModuleDetailRegistry.swift`, and `docs/ARCHITECTURE.md` as source of truth for what ships today. `BuiltInModules.swift` derives active instances from `ModuleRegistry`.
