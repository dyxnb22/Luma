...
| 6 | **Default-enabled module slimming (runtime)** | `MVP_SCOPE.md` D-012; Todo EventKit borderline; `REFACTOR_PLAN.md` P2.1 | Low if docs aligned; **high** if flipping switches | **High** if code changes defaults | **Defer / Needs User** | **No** — doc alignment only in P2.1 |
