...
| Wordbook | `wb` / `wordbook` / `words` | Available — due/new/wrong review; known/fuzzy/unknown/mastered; CSV/paste import; UK `say`; daily goal; backup; `luma wordbook import-wordpet` | on |
