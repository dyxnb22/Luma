...
public enum LauncherPerfCounters {
    public enum Key: String, CaseIterable, Sendable {
        ...
        case queryCancelOnHide = "query.cancelOnHide"
        case snapshotApplyDropped = "snapshot.applyDropped"
        case panelHide = "panel.hide"
        case moduleWarmupStarted = "module.warmupStarted"
        case moduleWarmupFinished = "module.warmupFinished"
        case moduleWarmupTimedOut = "module.warmupTimedOut"
        case moduleHandleCold = "module.handleCold"
        case cacheQueryHit = "cache.query.hit"
        case cacheQueryMiss = "cache.query.miss"
    }
